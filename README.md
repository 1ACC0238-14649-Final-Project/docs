...
| TF | 02/12/2025 | Irving Allcca Diego Cacho Adrian Donayre Mariano Oblitas Carlos Fernandez | Capítulo IV: Solution Software Design Avance de Conclusiones, Bibliografía y Anexos |
...
| ----- | ----- | ----- |
| **7.c1. Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de ingeniería de software** | **Irving Allcca** TB1: Profundicé en conceptos como *Candidate Context Discovery* y *Bounded Context: Gigs*, lo que me ayudó a comprender mejor la estructura del sistema. También colaboré en el avance de la presentación del proyecto. TP1:Al desarrollar las vistas buyer_pull_detail y buyer_peek_seller_account, profundicé en la implementación de interfaces móviles orientadas a experiencia de usuario. Asimismo, la elaboración del Keynote y grabación del video me permitió reforzar conocimientos en comunicación técnica, esenciales en el ciclo de vida del desarrollo de software. TB2: En esta entrega reforcé mis conocimientos en Flutter corrigiendo la pantalla de visualización del pull e implementando su nueva versión en Flutter, además de participar en la validación del producto mediante la grabación de la *Validation Interview*, consolidando habilidades en construcción de interfaces y retroalimentación funcional. TF: Apliqué nuevos conocimientos al corregir el flujo de pulls en Android y desarrollar la funcionalidad de consolidación del pull en Flutter, integrando validación, navegación y diseño funcional. También participé en la grabación y avance de la exposición final.  **Diego Cacho** TB1: Para la TB1, realicé diversos puntos relacionados con el bounded context Chat, esto me permitió conocer aún más acerca de nuestro proyecto, teniendo en cuenta el funcionamiento interno de TP1: Implementé el frontend de la pantalla Buyer Account, lo que requirió comprender e integrar componentes específicos del framework móvil. Esto me permitió consolidar mis conocimientos sobre arquitectura cliente-servidor en aplicaciones móviles, además de aplicar conceptos aprendidos sobre gestión de configuración y sistemas organizacionales durante el avance de capítulos teóricos. TB2: Para esta entrega, comenzamos a ver los temas de Flutter para nuestra aplicación, desarrolle la pantalla del Perfil del usuario utilizando estas nuevas tecnologías, además también tuve avances en el documento principal, mas que todo la sección de las Evaluaciones segun Heurísticas. TF: Para el TF, realice las correcciones de la entrega pasada y grabe mis diapositivas para la exposición final del trabajo. TF: Actualicé conocimientos técnicos documentando secciones de Flutter/Android, corrigiendo el reporte y colaborando en el avance y grabación de la presentación final.  **Adrian Donayre** TB1: Al realizar contenido relacionado al bounded context User aplicando DDD, me permitió pasar de ideas generales a una arquitectura con límites claros, lenguaje ubicuo y reglas de negocio explícitas. TP1:Durante el desarrollo del flujo de Gigs, traduje conceptos abstractos en funcionalidades concretas, aplicando principios de diseño modular y separación de responsabilidades. Además, la documentación del segundo sprint me ayudó a profundizar en técnicas de documentación ágil y seguimiento de procesos, competencias clave en proyectos reales de software. TB2: Durante el TB2, actualicé mis conocimientos en desarrollo móvil al trabajar simultáneamente con Android (Jetpack Compose) y Flutter, profundizando en conceptos de manejo de estado, navegación y modularización mientras desarrollaba pantallas como My Gigs y Gig Detail, además de validar el funcionamiento en dispositivos reales. TF: Apliqué nuevos conocimientos al evaluar funcionalidades en ambas aplicaciones, integrar bibliografía académica y participar en el desarrollo y grabación de la exposición final.  **Mariano Oblitas** TB1: Revisé conceptos clave de arquitectura de software y *Bounded Contexts*, aplicándolos en la estructuración del proyecto. Además, participé en la creación del repositorio y documentos base, reforzando conocimientos en entornos colaborativos. TP1: La implementación integral de la landing page, login y registro en Android Studio me permitió integrar conocimientos de diseño UX/UI con desarrollo móvil. Asimismo, realicé el despliegue de backend y base de datos, fortaleciendo mis habilidades en DevOps y despliegue continuo, fundamentales en la ingeniería moderna de software. TB2: Para esta entrega desarrollé las pantallas de Login y Register en Flutter, grabé el video *About The Product* y realicé correcciones finales en el prototipo y landing, reforzando habilidades técnicas y comunicacionales. TF: Apliqué conocimientos avanzados al documentar el sprint final, corregir el reporte y elaborar la presentación mediante la grabación y el avance de diapositivas, asegurando coherencia técnica entre entregables.  **Carlos Fernandez** TB1: Mediante el aprendizaje previo en cursos anteriores complementé lo aprendido en el desarrollo de bounded context, asi como la adecuada implementación de los diagramas relacionados. TP1:Diseñé wireframes, wireflows y user flows para representar visualmente las interacciones del sistema, reforzando mis habilidades en diseño centrado en el usuario. Posteriormente, desarrollé la vista buyer_my_pulls, aplicando principios de integración entre diseño y lógica de presentación, alineados con buenas prácticas de frontend. TB2: En esta entrega corregí la pantalla My Pull en Android e implementé las pantallas Create Gig y My Pulls en Flutter, permitiéndome afianzar mis conocimientos en diseño funcional, navegación y consistencia visual entre plataformas móviles. TF: Reforcé conocimientos realizando el deploy funcional en Android y Flutter, investigando configuraciones de distribución y contribuyendo a la elaboración y grabación de la presentación final.** | El equipo demostró un avance significativo en la actualización y profundización de conocimientos técnicos esenciales para el desarrollo profesional. Cada integrante reforzó conceptos de Domain-Driven Design (DDD), Bounded Contexts y arquitectura de software, aplicándolos directamente en la estructuración del proyecto. Esto permitió pasar de ideas generales a modelos más claros y organizados, con roles y límites definidos, consolidando la base técnica del trabajo en equipo. Asimismo, el uso de repositorios, documentos colaborativos y presentaciones contribuyó a mejorar la comunicación y la integración de los aportes individuales. En el TF, el equipo consolidó su aprendizaje técnico mediante validación de funcionalidades, despliegue móvil, documentación final y refinamiento del producto, demostrando una capacidad madura de integración de conocimientos y preparación profesional. |
| **7.c2. Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de tecnologías de ingeniería de software** | **Irving Allcca** TB1: Al abordar los contextos del sistema, entendí la importancia de seguir aprendiendo para proponer soluciones más sólidas y adaptadas al desarrollo de software en equipo. TP1: La preparación del Keynote y la grabación del video requirieron explorar nuevas herramientas de presentación técnica. Esto me hizo consciente de la necesidad de seguir aprendiendo formas efectivas de comunicar ideas de software, habilidad clave para el trabajo en equipo y la gestión de proyectos. TB2: El desarrollo en Flutter y las correcciones en la pantalla de visualización del pull me llevaron a investigar nuevas formas de manejar vistas, estados y validaciones, reforzando la importancia del aprendizaje continuo en tecnologías móviles. TF: Fortalecí mi aprendizaje investigando mejoras en navegación, validación y flujo lógico para Android y Flutter, además de reforzar habilidades de comunicación mediante la elaboración de la presentación final.**  **Diego Cacho** TB1: El avance realizado en la primera entrega del proyecto me permitió adentrarme a las soluciones de problemas con la tecnología de desarrollo móvil de Android, de esta manera organice diversos puntos y logre comprender más la lógica de GigU en un entorno móvil. TP1: En el proceso de desarrollo de la interfaz Buyer Account, identifiqué limitaciones en mis conocimientos sobre desarrollo móvil, lo que me llevó a investigar sobre componentes y buenas prácticas en Android. Esta experiencia reforzó en mí la importancia de mantener una actitud de aprendizaje continuo frente a nuevas tecnologías. TB2: Esta entrega nos trajo nuevos retos por medio del uso de una plataforma y/o entorno diferente al que estabamos acostumbrados, utilice Flutter para realizar la pantalla de Perfil del usuario, esta tecnología nueva resulto interesante y considero que me ayudará al realizar aplicaciones en un futuro. TF: Como entrega final, utilizamos nuevas tecnologías, mas notablemente el uso de Firebase App Distribution, una herramienta poderosa pero un poco confusa la cual nos permitio distribuir las versiones preliminares de nuestra aplicación móvil. TF: Amplié mi aprendizaje al investigar nuevas configuraciones de distribución, corregir el reporte final y participar en la grabación de la exposición, reforzando habilidades profesionales clave.  **Adrian Donayre** TB1: En mi desarrollo identifiqué varias tecnologías que son factibles para la elaboración del proyecto. Así reconocí la importancia de mantener un hábito de aprendizaje constante para conocer todo el repertorio de herramientas a mi disposición. TP1:La documentación del sprint me permitió reflexionar sobre la mejora continua del equipo. Identifiqué herramientas ágiles que no dominaba, lo que me motivó a investigarlas y aplicarlas, reconociendo que el aprendizaje permanente es crucial para adaptarme a dinámicas de trabajo técnico colaborativo. TB2: El avance del TB2 reforzó mi comprensión de que el aprendizaje permanente es indispensable en el desarrollo profesional. Trabajar con dos tecnologías diferentes (Android y Flutter) me mostró que adaptarse, investigar y aprender continuamente es esencial para producir soluciones modernas, escalables y centradas en el usuario. TF: Complementé mi aprendizaje con validación funcional, elaboración de bibliografía especializada y participación en la preparación y grabación de la presentación final.  **Mariano Oblitas** TB1: Al trabajar en los *Pulls* y el avance de diapositivas, identifiqué la necesidad de seguir aprendiendo sobre herramientas y buenas prácticas, lo cual me ayudó a mejorar mi enfoque técnico dentro del proyecto. TP1:Para implementar la landing page y el sistema de autenticación móvil, necesité adquirir conocimientos adicionales sobre diseño responsive, seguridad básica y despliegue en entornos reales. Esto evidenció la necesidad de mantenerme actualizado en un campo en constante evolución como lo es el desarrollo full stack. TB2: En这 entrega, trabajar en las pantallas de Login y Register en Flutter y en la grabación del video del producto me exigió investigar nuevas herramientas y prácticas, reforzando la importancia del aprendizaje permanente en diseño, comunicación técnica y desarrollo móvil. TF: Reforcé la importancia del aprendizaje continuo al documentar el sprint final, corregir el reporte y trabajar en la presentación, asegurando la articulación clara de los resultados.  **Carlos Fernandez** TB1: Para mi participación en este proyecto tuve que reforzar lo aprendido en cursos pasados, así como investigar sobre las adecuadas prácticas que se aplican para el continuo desarrollo como estudiante de Ingeniería de Software. TP1:La construcción de flujos de usuario y su traducción al frontend me exigió investigar nuevas herramientas de diseño y principios de accesibilidad. Este proceso fortaleció mi convicción de que el aprendizaje permanente es vital para crear soluciones tecnológicamente viables y centradas en el usuario. TB2: En esta entrega tuve que investigar nuevas estrategias de diseño móvil para mantener coherencia entre las pantallas de Android y Flutter, reafirmando la importancia del aprendizaje continuo como parte fundamental del desarrollo profesional. TF: Consolidé aprendizajes investigando configuraciones de despliegue móvil, aplicando buenas prácticas para Android y Flutter y participando en la grabación de la exposición final. | Se reconoció la importancia del aprendizaje continuo como eje fundamental para el crecimiento profesional. La necesidad de investigar nuevas tecnologías, buenas prácticas y herramientas quedó reflejada en las acciones realizadas: desde la exploración de soluciones móviles hasta la implementación de metodologías de trabajo colaborativo. El equipo asumió que el aprendizaje permanente no solo refuerza los conocimientos previos, sino que también garantiza la capacidad de adaptarse a las demandas del proyecto y a la evolución constante de la ingeniería de software. En el TF se fortaleció esta actitud mediante validación, mejora de reportes, despliegues móviles, documentación final y presentación profesional, demostrando que el aprendizaje continuo se integró naturalmente en el cierre del proyecto. |
...
- **Aplicación Móvil (Android - Flutter):** Interfaz principal para interacción de usuarios, desarrollada en Android Studio con Flutter. Incluye almacenamiento local (SQLite/Shared Preferences) y acceso a recursos del dispositivo (cámara, ubicación, etc.).  
- **API RESTful:** Backend en ASP.NET Core que maneja la lógica de negocio, integra con servicios externos y persiste información.  
...
- **Aplicación Móvil (Android - Flutter):** Aplicación cliente instalada en dispositivos, conectada a la API vía HTTPS.  
- **API RESTful (ASP.NET Core):** Desplegada en contenedores (Docker/Kubernetes).  
- **Base de Datos MySQL:** Servicio gestionado con réplicas y backups.  
- **Blob Storage:** Para almacenar imágenes, documentos y archivos de usuarios.  

**Relaciones:**  
- La Aplicación Móvil consume los endpoints de la API a través de HTTPS.  
...
- **Load Balancer / Reverse Proxy (WAF):** Encargado de balancear tráfico, gestionar certificados TLS y aplicar reglas de seguridad.  
- **API RESTful (ASP.NET Core en contenedores Docker/Kubernetes):** Lógica central desplegada en clúster escalable con soporte a workers de segundo plano.  
- **Base de Datos MySQL:** Persistencia de información con réplicas y respaldos automáticos.  
- **Blob Storage:** Almacenamiento de archivos (imágenes, documentos).  

**Relaciones:**  
- La Aplicación Móvil se conecta al API a través del Load Balancer / Reverse Proxy mediante HTTPS.  
- El API se comunica con la Base de Datos, el Blob Storage y con los Servicios Externos usando conexiones seguras (TLS).  
...
- **Contenedores (Docker/Kubernetes):** despliegue portable y escalable del API.  
