...
|:---------------:| ----- | ----- | ----- |:-------------------------:|
|      US03       | Navegación Intuitiva en la Landing Page | Como visitante de GigU, deseo que la landing page tenga una barra de navegación clara y accesible para encontrar fácilmente las secciones importantes. | **Escenario 01:** Given que estoy en la landing page, When hago clic en el menú, Then debería ver opciones como “Inicio”, “Buscar Freelancer”, “Publicar Proyecto” y “Sobre Nosotros”. **Escenario 02:** Given que paso el cursor sobre un ítem, When el ítem está activo, Then debería resaltarse. | EP01 |
...
|   SP08   | Sistema de Calificaciones y Opiniones     | Como equipo de desarrollo, deseo investigar la forma más segura y eficiente de almacenar calificaciones y opiniones, evitando fraudes o manipulación.                                                        | **Escenario 01:** Given que se diseñe un esquema de base de datos para reseñas, When se prueba en un prototipo, Then debe soportar calificaciones con comentarios vinculados a proyectos finalizados. **Escenario 02:** Given que se documentan riesgos como spam o reseñas falsas, When se presenta el informe, Then este debe incluir medidas de mitigación (ej. validación de usuarios con proyectos completados). |            EP11           |
